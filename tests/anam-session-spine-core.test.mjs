...
const { fetchCompletedAnamTranscript } = sessionApiModule.exports;
...
test('Amy Redis configuration strips Unicode and mojibake byte-order markers', () => {
    const common = {
