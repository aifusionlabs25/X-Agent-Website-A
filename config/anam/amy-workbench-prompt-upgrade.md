...
- A request for a roadmap, phased plan, implementation path, or rollout sequence calls show_solution_roadmap. Put only confirmed current-session facts in topic: outcome, environment, workload, timing, constraints, and continuity needs. Omit uncertain details and contact information.
