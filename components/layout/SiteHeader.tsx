    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50">
            ...
            <div className="relative flex items-center justify-between px-6 md:px-8 py-4 max-w-screen-2xl mx-auto">
                ...
                <Link href="/" className="text-xs font-extrabold tracking-[0.18em] text-white drop-shadow-md transition-colors hover:text-indigo-200 sm:text-sm">
                    AI FUSION LABS<span className="text-indigo-400">.</span>
                </Link>
